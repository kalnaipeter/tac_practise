...
- Filename format: `feature-{adw_id}-{descriptive-name}.md`
  - Replace `{descriptive-name}` with a short feature name (e.g., "dark-mode", "search-filter", "table-paginator")
...
- After creating the documentation file, read `.github/prompts/conditional-docs.prompt.md`
...
After creating the documentation, add this entry to `.github/prompts/conditional-docs.prompt.md`:
