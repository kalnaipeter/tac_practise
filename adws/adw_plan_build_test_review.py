...
"""
ADW Plan, Build, Test & Review — tac_practise

Usage: uv run adw_plan_build_test_review.py <issue-number> [adw-id]

Composition that chains: Plan → Build → Test → Review.
Full validation pipeline with feedback loop testing and spec review.
...
def main():
    ...
    print(f"\n✅ Plan-Build-Test-Review workflow finished successfully for issue #{issue_number}")
